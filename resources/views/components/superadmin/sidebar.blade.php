...
<aside :class="sidebarOpen ? 'w-64' : 'w-20'"
    ...
    <nav class="flex-1 px-3 space-y-1" style="overflow: visible;">
        <div x-show="sidebarOpen" class="px-3 pt-4 pb-2" x-transition.opacity.duration.300ms>
            <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Utama</p>
        </div>
        ...
        <div class="relative group/dash">
            ...
            <div x-show="!sidebarOpen" class="absolute left-full top-1/2 -translate-y-1/2 ml-3 z-50 pointer-events-none opacity-0 group-hover/dash:opacity-100 transition-opacity duration-200">
        ...
        <div class="relative group/nasabah">
            ...
            <div x-show="!sidebarOpen" class="absolute left-full top-1/2 -translate-y-1/2 ml-3 z-50 pointer-events-none opacity-0 group-hover/nasabah:opacity-100 transition-opacity duration-200">
                <div class="relative bg-slate-800 text-white text-xs font-medium px-3 py-1.5 rounded-md whitespace-nowrap">
                    <div class="absolute -left-1 top-1/2 -translate-y-1/2 w-2 h-2 bg-slate-800 rotate-45"></div>
                    Data Nasabah
                </div>
    ...
    <div class="flex-shrink-0 border-t border-slate-100 p-3 relative" x-data="{ profileOpen: false }">
        ...
        <div class="flex items-center rounded-lg transition-all duration-300"
            ...
            <div class="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white font-bold text-sm flex-shrink-0 transition-all duration-200"
